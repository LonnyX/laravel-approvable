...
class Approval extends Model
{
    ...
    public function resolveData()
    {
        ...
        $this->data = [
            'approve_id'         => $this->id,
            'approve_event'      => $this->event,
            'approve_created_at' => $this->serializeDate($this->created_at),
        ...
        // Modified laravel-approvable attributes
    ...
    /**
     * Get the laravel-approvable modified attributes.
     *
     * @param bool $json
     * @param int  $options
     * @param int  $depth
